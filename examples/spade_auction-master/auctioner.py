...
class Auctioner(Agent.Agent):
            ...
            for key, auction in self.myAgent.auctions.items():
                if auction['time'] > 0 and auction["countdown"]:
                    ...
                    if auction['time'] <= 0:
                        ...
                        print "Inform Winner:"+msg
                        for rec in auction["bidders"]:
                            msg.receivers = [rec]
                            self.myAgent.send(msg)
                            print "Inform bidder:"+rec
    ...
    def _setup(self):
        ...
        self.auctions["PS3"] = {'price':600, 'name':'PS3', 'desc':'Playstation 3 Giant Crab','time':50,'image':'https://upload.wikimedia.org/wikipedia/commons/9/93/250GB_Slim_PS3.jpg','countdown':False,'bidders':[],"current_winner":""}
        self.auctions["XBX"] = {'price':490, 'name':'Xbox', 'desc':'Microsoft Xbox 360','time':2200,'image':'https://upload.wikimedia.org/wikipedia/commons/a/ab/Xbox-360-Arcade-wController.jpg','countdown':False,'bidders':[],"current_winner":""}
